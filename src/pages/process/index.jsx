            ...
            <ol className="relative border-l border-gray-200 dark:border-gray-700">
              ...
              <li className="mb-10 ml-10">
                ...
                <div className="items-start justify-between rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 sm:flex">
                  ...
                  <div className="max-w-3xl text-sm font-normal text-gray-500 dark:text-gray-300">
                    ...
                    equally well for physical and digital design. No matter what
                    you design, whether it&apos;s a digital app or a physical
              ...
              <li className="mb-10 ml-10">
                ...
                <div className="items-start justify-between rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 sm:flex">
                  ...
                  <div className="max-w-3xl text-sm font-normal text-gray-500 dark:text-gray-300">
                    ...
                    As you continue developing empathy for your users, focus on
                    the emotional part of interactions (how do products make
                    users feel?). Emotions play a tremendous role in how we
                    think about products. When users develop positive
                    associations with products, they are more likely to continue
                    using them. That&apos;s why it&apos;s essential to collect
                    emotional responses (both positive and negative) that test
                    participants&apos; experience when performing a particular
                    task in a product. We use the following techniques to help
              ...
              <li className="mb-10 ml-12">
                ...
                <div className="items-start justify-between rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 sm:flex">
                  ...
                  <div className="max-w-3xl text-sm font-normal text-gray-500 dark:text-gray-300">
                    <h2 className="text-lg font-bold text-zinc-700">Define</h2>
                    At this stage, we analyze the qualitative and quantitative
                    data we obtained during the empathize stage to draw insights
                    from it. The information will define a problem statement and
                    guide the ideation process. Clear problem statements will
                    navigate the product team throughout the design process. In
                    addition, those statements will help you understand what
                    features and functions your users need to solve their
                    problems.
                    <div className="my-3 rounded-lg border border-gray-200 bg-gray-50 p-2 text-sm font-normal text-gray-500 dark:border-gray-500 dark:bg-gray-600 dark:text-gray-300">
                      <ul className="list-disc px-4">
              ...
              <li className="mb-10 ml-10">
                ...
                <div className="items-start justify-between rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 sm:flex">
                  ...
                  <div className="max-w-3xl text-sm font-normal text-gray-500 dark:text-gray-300">
                    <h2 className="text-lg font-bold text-zinc-700">Ideate</h2>
                    <p>
                      Ideation, or generating ideas, is a phase in which you go
                      from understanding problems to exploring solutions. The
                      identified ideas will be prototyped and tested with people
              ...
              <li className="mb-10 ml-10">
                ...
                <div className="items-start justify-between rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 sm:flex">
                  ...
                  <div className="max-w-3xl text-sm font-normal text-gray-500 dark:text-gray-300">
                    <h2 className="text-lg font-bold text-zinc-700">Testing</h2>
                    <p>
          ...
          <section className="max-w-3xl space-y-10">
            <div>
              ...
              <p className="text-base font-normal text-gray-500 dark:border-gray-500 dark:text-gray-300">
                ...
                problems and desires. This deep user comprehension ensures that
                design decisions are made not on assumptions but on validated
                user data, which can significantly reduce the risk of
                misalignment with user expectations. By prioritizing user
            ...
            <div>
              ...
              <p className="text-base font-normal text-gray-500 dark:border-gray-500 dark:text-gray-300">
                ...
                norm. Design thinkers prototype rapidly, welcoming feedback as a
                beacon for refinement, and not as a sign of failure. This
                agility ensures that the end result isn&apos;t just a static
                product, but a reflection of a continuous dialogue between the
                designer, the user, and the problem space. The iterative nature
                of the design thinking process allows for solutions to be
                responsive, flexible, and deeply empathetic to the user&apos;s
