    ...
    <div className="flex min-h-screen flex-col">
      ...
      >
        ...
        <div className="education my-12">
          ...
          <div className="mt-6 flex items-center gap-8 sm:gap-16 ">
            {/* School Logos */}
            {[
              {
                light: waterlooLight,
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col">
              <Tab.List className="flex w-full border-gray-300">
                  ...
                  <Tab
                    ...
                    className={({ selected }) =>
                      classNames(
                        ...
                        ' border-b-2 px-8 py-2 text-center font-medium'
                      )
                    }
                  >
                    {tab.name}
                  ...
                  >
                    {tab.features.map(({ heading, imageSrc, link }, idx) => (
                      <div key={idx} className="p-4">
                        ...
                        />
                        <h3 className="mt-2 font-medium">{heading}</h3>
                        {link && (
                          <Link
                            href={link}
                            onClick={(e) => {
                            ...
                            className="mt-1 block text-blue-800 hover:underline dark:text-blue-500"
                          >
                            View Certificate
                          </Link>
                        )}
